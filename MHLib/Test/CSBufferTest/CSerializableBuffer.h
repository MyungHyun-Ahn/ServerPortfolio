...
public:
	...
	inline static MHLib::memory::CTLSPagePoolManager<(int)DEFINE::PACKET_MAX_SIZE, 16, false> s_sPagePool512 = MHLib::memory::CTLSPagePoolManager<(int)DEFINE::PACKET_MAX_SIZE, 16, false>();
};
